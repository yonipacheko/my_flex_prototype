...
ActiveRecord::Schema.define(version: 20131005051316) do

  create_table "another_categorizations", force: true do |t|
    t.integer  "video_id"
  ...
  create_table "categorizations_1", force: true do |t|
    t.integer  "video_id"
    t.integer  "category_id"
    t.datetime "created_at",  null: false
    t.datetime "updated_at",  null: false
  ...
  create_table "join_of_categories", force: true do |t|
    t.integer  "video_id"
    t.integer  "category_id"
    t.datetime "created_at",  null: false
    t.datetime "updated_at",  null: false
